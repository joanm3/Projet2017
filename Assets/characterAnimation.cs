...
//	public float moveSpeed = 0f;
	...
	void SetAnimatorDirection(Vector3 characterForward, Vector3 characterUp, Vector3 inputAlongSurface)
	{
	...
	void SetAnimatorInclinaison(Vector3 inputDirection, Vector3 surfaceDirection, float inputSpeed, float surfaceSpeed)
	{
...
//		characterAnimator.SetFloat("MovingSpeed", Mathf.Abs(moveSpeed));
	...
	void SetMovingMode(float totalSpeed, float speedInputMax)
	{
